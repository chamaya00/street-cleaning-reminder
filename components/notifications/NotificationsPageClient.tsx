      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <main className="max-w-3xl mx-auto px-4 py-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">
                Your notification schedule will appear here
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-500">
                Select blocks on the map to set up notifications
              </p>
              <a
                href="/"
                className="inline-block mt-4 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-sm font-medium"
              >
                Select Blocks
              </a>
            </div>
          ...
          <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Coming soon: Customize when and how you receive notifications.
            </p>
          </div>
        </main>
      </div>
